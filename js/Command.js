...
var aboutme = "Quentin Mélotte. I am a computer science student who seeks to understand the very origins of computing in order to comprehend how it was built and how it works at its core. I am seeking to build projects and products, with my ultimate goal being to send an object of my own design into space."
var start =
    [
...
var FAQ =
    [
        ...
        '<br>',
        '<span id="Question">Why did you create a portfolio in the form of a terminal instead of a beautiful design with animations and the latest web frameworks?</span>',
        '<span>I believe that creating a portfolio in the form of a terminal represents me much more than creating a sophisticated design. I ABSOLUTELY DO NOT want to work in web development and as a big fan and enthusiast of from scratch programming, I find the terminal more representative of myself.</span>',
        '<br>',
...
function started()
{
    var clas = document.getElementById("start");
